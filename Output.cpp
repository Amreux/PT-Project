...
void Output::CreateDesignModeToolBar() const
{
	...
	MenuItemImages[ITM_COPY_CARD] = "images\\ITM_COPY_CARD.jpg";
	MenuItemImages[ITM_CUT_CARD] = "images\\ITM_CUT_CARD.jpg";
	MenuItemImages[ITM_PASTE_CARD] = "images\\ITM_PASTE_CARD.jpg";
	MenuItemImages[ITM_DELETE_GAME_OBJECT] = "images\\ITM_DELETE_GAME_OBJECT.jpg";
	MenuItemImages[ITM_SAVE_GRID] = "images\\ITM_SAVE_GRID.jpg";
	MenuItemImages[ITM_OPEN_GRID] = "images\\ITM_OPEN_GRID.jpg";
...
void Output::CreatePlayModeToolBar() const
{
	...
	MenuItemImages[ITM_NEW_GAME] = "images\\ITM_NEW_GAME.jpg";
...
void Output::DrawSnake(const CellPosition& fromCell, const CellPosition& toCell) const
{
	...
	int xHead1, xHead24, xHead3, yHead13, yHead2, yHead4;
	xHead1 = cellStartX; xHead24 = cellStartX + xChange; xHead3 = cellStartX + 2 * xChange;
	yHead13 = y1; yHead2 = y1 - yChange; yHead4 = y1 + yChange;

	int xHead[4] = { xHead1 + 2,xHead24 + 2,xHead3 + 2,xHead24 + 2 };
	int yHead[4] = { yHead13,yHead2,yHead13,yHead4 };
	pWind->DrawPolygon(xHead, yHead, 4);
